    ...
    public class ClassesTests
    {
       ...
       [TestMethod]
        public void VehicleConstructorTests()
        {
            ...
            Vehicle spaceship = new Vehicle("Enterprise", "Galaxy", 100000, VehicleType.Plane);
        }
        ...
        public void CalculatorTests()
        {
            ...
            int age = calculatorInstance.CalculateAge(new DateTime(1975, 12, 09));
        ...
        {
            Person person = new Person("Michael", "Pabody", new DateTime(1988, 04, 21));
            ...
            //Single line instance of newing up a person
        ...
        Person _person = new Person("Luke", "Skywalker", new DateTime(1951, 09, 25));

        [TestMethod]
        public void PersonTransportTest()
        {
            _person.Transport = new Vehicle("X-Wing", "Starship", 1000, VehicleType.Plane);
            Console.WriteLine($"{ _person.FullName} flies a {_person.Transport.Make}");
